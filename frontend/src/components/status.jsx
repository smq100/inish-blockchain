    ...
    render() {
        return (
            <Container>
                ...
                <Row>
                    <Col sm="6">
                        <h5 className="text-muted pt-1"><div><i className="fa fa-cubes"></i></div> No. of Blocks Mined</h5><hr />
                        <h5 style={{ color: '#007bff' }}>#<b>{this.state.length} </b></h5>
                    </Col>
                    <Col md="6"> <br />
                        <h5 className="text-muted pt-1"><div>Node Address <a href="/get_chain"><i className="fa fa-refresh"></i></a></div></h5><hr />
